...
from CyberPoliciesProcedures import views as mainView
...
urlpatterns = [
    ...
    path('delete-user/', admins.DeleteUsers, name='delete_user'),
    ...
    path("cyResults/", usr.cyResults, name="cyResults"),
    path("GPTTest/", usr.GPTTest, name="GPTTest"),
